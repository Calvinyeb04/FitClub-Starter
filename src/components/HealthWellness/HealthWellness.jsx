      ...
      <div className="content-wrapper">
        <div className="NavBar">
          ...
          <ul>
            ...
            <li><Link to="/Our-instructors">Our instructors</Link></li>
            <li><Link to="/Classes">Classes</Link></li>
            <li><Link to="/Location">Location</Link></li>
            <li><Link to="/Blog">Blog</Link></li>
            <li className="STAR"><Link to="/Bookaclass">Book a Class</Link></li>
          </ul>
        </div>
          ...
          <div className="bottom-left">
            <div className="image-text-row">
              <div className="image-container">
                <img src={Aerobics} alt="Aerobics" className="bottom-image" />
              </div>
              <div className="image-container">
                <img src={imageasset} alt="Instructor Training" className="bottom-image" />
              </div>
            </div>
          </div>
